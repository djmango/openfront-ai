...
| `SHOWCASE_MAX_EPISODE_TICKS` | `ofcore::DEFAULT_MAX_EPISODE_TICKS` (21000) | Same `--max-episode-ticks` as train/watch |
| `SHOWCASE_MAX_STEPS` | `watch_max_steps_for_ticks(...)` | Decision cap derived from tick budget |
