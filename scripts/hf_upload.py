...
Training code and usage: [djmango/openfront-ai](https://github.com/djmango/openfront-ai)
...
def main() -> None:
    ...
    if what == "dataset":
        ...
        for src, dst in [
            ("runs/ae_v1/ae.pt", "ae.pt"),
            ("ae/model.py", "model.py"),
            ("assets/loss_curve.png", "loss_curve.png"),
            ("assets/recon_world.png", "recon_world.png"),
        ]:
