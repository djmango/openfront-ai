...
fn host_grids_from_item_latents(
    ...
    items
        ...
        .map(|(it, latent)| {
            ...
            host_grids_from_latent(&refs, &batched, coarse).map(|mut grids| grids.remove(0))
        })
        .collect()
}
