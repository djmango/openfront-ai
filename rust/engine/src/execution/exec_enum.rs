...
pub enum ExecEnum {
    ...
    EmbargoAll(EmbargoAllExecution),
    Retreat(RetreatExecution),
    BoatRetreat(BoatRetreatExecution),
...
impl Execution for ExecEnum {
    fn init(&mut self, game: &mut Game, tick: u32) {
        match self {
            ...
            ExecEnum::TradeShip(e) => e.init(game, tick),
            ...
            ExecEnum::Embargo(e) => e.init(game, tick),
            ExecEnum::EmbargoAll(e) => e.init(game, tick),
            ExecEnum::Retreat(e) => e.init(game, tick),
            ExecEnum::BoatRetreat(e) => e.init(game, tick),
    ...
    fn tick(&mut self, game: &mut Game, tick: u32) {
        match self {
            ...
            ExecEnum::TradeShip(e) => e.tick(game, tick),
            ...
            ExecEnum::Embargo(e) => e.tick(game, tick),
            ExecEnum::EmbargoAll(e) => e.tick(game, tick),
            ExecEnum::Retreat(e) => e.tick(game, tick),
            ExecEnum::BoatRetreat(e) => e.tick(game, tick),
    ...
    fn is_active(&self) -> bool {
        match self {
            ...
            ExecEnum::TradeShip(e) => e.is_active(),
            ...
            ExecEnum::Embargo(e) => e.is_active(),
            ExecEnum::EmbargoAll(e) => e.is_active(),
            ExecEnum::Retreat(e) => e.is_active(),
            ExecEnum::BoatRetreat(e) => e.is_active(),
    ...
    fn active_during_spawn(&self) -> bool {
        match self {
            ...
            ExecEnum::TradeShip(e) => e.active_during_spawn(),
            ...
            ExecEnum::Embargo(e) => e.active_during_spawn(),
            ExecEnum::EmbargoAll(e) => e.active_during_spawn(),
            ExecEnum::Retreat(e) => e.active_during_spawn(),
            ExecEnum::BoatRetreat(e) => e.active_during_spawn(),
...
impl ExecEnum {
    ...
    pub fn debug_label(&self) -> String {
        match self {
            ...
            ExecEnum::TradeShip(_) => "TradeShipExecution".into(),
            ...
            ExecEnum::Embargo(_) => "Embargo".into(),
            ExecEnum::EmbargoAll(_) => "EmbargoAll".into(),
            ExecEnum::Retreat(_) => "Retreat".into(),
            ExecEnum::BoatRetreat(_) => "BoatRetreat".into(),
